...
public class PotatoFarm extends WorkBuilding {

	public PotatoFarm(City city, Person owner, List<Person> personsInvolved, GoodStock goodStock, ITransportBehavior transportBehavior) throws CapacityUnderflowException, CapacityOverflowException {
	...
	protected void initializeBuildingType() {
		buildingType = BuildingType.PotatoFarm;
	}
